...
if (flag('--json')) console.log(JSON.stringify({ root: result.root, files: result.scanned, counts, findings: result.findings }, null, 2));
  ...
  console.log(`\nfaultline ${VERSION} · scanned ${result.scanned} files in ${result.root}\n`);
